...
<iframe src="slide.html" style="width:960px;height:365px;max-width:100%;overflow:hidden;border:none;padding:0;margin:0 auto;			display:block;" marginheight="0" marginwidth="0"></iframe>
  ...
  <div class="gallerycontent">
    <h6><b>E-restaurant </b><br/>
    	Address: PJ Ramchandani Marg, <br/>
        Apollo Bunder, Colaba, Mumbai <br/><br/>
        Phone: +91 9594848120 <br/><br/>
        Email Us: info@erestaurant.com <br/><br/>
        Hours: Open everyday   8 AM to 12 AM <br/><br/><br/>
    </h6>
   </div>
