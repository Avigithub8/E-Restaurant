      ...
      <form action="NewUser" method="post">
          <div class="login2">
            ...
            <input class="lform" name="email" type="text" id="email" /><br/><br/>
             <input class="lform" name="pass" type="password" id="password" /><br/><br/>
            <input  class="lform"name="phone" type="text" id="name" /><br/><br/>
            <input class="lform" name="address" type="text" id="address" /><br/><br/>
