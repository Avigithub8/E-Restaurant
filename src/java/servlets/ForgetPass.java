...
public class ForgetPass extends HttpServlet {
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            session.setAttribute("msg","Your Password is Successfully Sent on Your Mail.");
